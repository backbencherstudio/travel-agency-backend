...
export class EscrowController {
  ...
  @ApiOperation({
    summary: 'Get retained funds for vendor',
    description: 'Vendor can see all funds held in escrow for their bookings',
  })
  @Get('funds')
  ...
  @ApiOperation({
    summary: 'Get Stripe Connect onboarding link for vendor',
    description: 'Vendor can get onboarding link to complete Stripe Connect setup',
  })
  @Get('onboarding-link')
  ...
  @ApiOperation({
    summary: 'Manual partial release (Admin only)',
    description: 'Admin can manually trigger partial release of funds',
  })
  ...
  @ApiOperation({
    summary: 'Trigger final release',
    description: 'Trigger final release of remaining funds after trip completion',
  })
  ...
  @ApiOperation({
    summary: 'Handle client cancellation',
    description: 'Process client cancellation with partial refund (>30 days before trip)',
  })
  ...
  @ApiOperation({
    summary: 'Handle provider cancellation',
    description: 'Process provider cancellation with full refund',
  })
  ...
  @ApiOperation({
    summary: 'Handle dispute',
    description: 'Register a dispute and hold payment until resolution',
  })
  ...
  @ApiOperation({
    ...
    description: 'Admin resolves dispute by releasing funds or refunding',
  })
